...
test.describe('Main content' , () => {
    ...
    test('Should containa list to describe CRUD', async ({ page}) => {
        await page.goto(homePage);
...
test.describe('Footer tests', () => {
    test('Should contain a footer on the page', async ({ page }) => {
        await page.goto(homePage);
        await expect(page.locator('footer')).toContainText("In class Example #1");
    })
})

test.describe("Check about pag navigates to home page tests", () => {
    test('Should navigate to the home page from teh about page', async ({ page}) => {
